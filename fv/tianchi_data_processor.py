...
def random_select_samples(m1 = 10000, m2 = 10000, m3 = 2000, n1 = 8000, n2 = 2000, n3 = 2000):
    trainlist = random.sample([i+1 for i in range(m1)], n1)
    validlist = random.sample([i+1 for i in range(m2) if i+1 not in trainlist],n2)
    testAlist = [i+1 for i in range(m3)]
    print([len(trainlist), len(validlist), len(testAlist)])

    dict = {'train': trainlist,
            'valid': validlist,
            'testA': testAlist
            }
...
def random_select_samples_2(m1 = 10000, m2 = 10000, m3 = 2000, n1 = 10000, n2 = 2000, n3 = 2000):
    samples_dict = {
